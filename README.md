...
- **[APIbase](https://github.com/whiteknightonhorse/APIbase)** - Unified API hub for AI agents with 56+ tools — flight search (Amadeus, Sabre), prediction markets (Polymarket), crypto, weather. x402 pay-per-call.
