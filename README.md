...
- **[APIbase](https://github.com/whiteknightonhorse/APIbase)** - MCP gateway aggregating 56+ real-time APIs across travel, prediction markets, crypto, and weather. Pay-per-call via x402 micropayments.
